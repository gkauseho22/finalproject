...
public class FreeBoardDTO {
    ...
    @Builder
    public FreeBoardDTO(int board_code, String list_title, String list_content, UserList user_code, Timestamp create_time, int views, int declaration, Long add_file) {
