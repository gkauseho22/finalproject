...
<div class="job_infomamam" style="display: flex">
 ...
 -->
			<button type="button" class="btn btn-secondary mollang_btn" disabled style="height:35px;width:100px; margin-top:5px; color: white;" >지역</button>
			<!-- 버튼 -->
			...
			<button type="button" class="btn btn-secondary mollang_btn" style="height:35px;width:100px; margin-top:5px;">검색</button>
		</div>
		...
		<div style="width: 100%; height: 100%; float: none; margin: 20px auto">
				<h5 class="card-title" style="text-indent: 0.5em; margin-top: 10px">훈련 과정</h5>
			<!-- content -->
			<div class="main_common">
				...
				<div class="main2"
					style="display:inline-block; width: 72%; background-color: ; border-bottom: 1px solid lightgray">
					<div class="job_root1_0_1" style="height:50px;">
						<h2>
							선택한 훈련 기관 명
						</h2>
					</div>
					<div class="space" style="height: 1px; background-color: lightgray; ">
					</div>
				<div class="map" style="display:flex; ">
					<div class="job_root1_0_2" style="background-color:;
										height: 550px; width:500px; border-right:1px solid lightgray; ">훈련정보</div>
				
				<div class="job_map"style="background-color:;
										 width:300px;">
					지도
				</div>
				</div>
